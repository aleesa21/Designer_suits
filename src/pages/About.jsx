...
export default function About() {
  ...
  return (
    <section
      ref={containerRef}
      className="min-h-screen bg-[#0a0a0a] text-[#EDE7DD] font-sans px-4 sm:px-8 md:px-16 py-24 md:py-28 border-t border-[#404040]/30 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto mb-16 md:mb-20 text-center md:text-left flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8 border-b border-[#404040]/30 pb-8 md:pb-12">
        <div className="space-y-3">
          <span className="gsap-hero text-[#C9A664] text-[10px] sm:text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] font-semibold block">
          ...
          <h1 className="gsap-hero font-serif text-3xl sm:text-4xl md:text-6xl uppercase tracking-wide font-light leading-tight">
            The Art of{" "}
            <span className="italic text-[#AE8A3E] font-normal">Bespoke</span>
          </h1>
        </div>
        <p className="gsap-hero text-neutral-300 text-xs sm:text-sm md:text-base max-w-lg font-light leading-relaxed">
      ...
      <div className="gsap-story-section max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mb-20 md:mb-28">
        <div className="lg:col-span-6 grid grid-cols-2 gap-3 sm:gap-4">
          <div className="gsap-story-img relative h-64 sm:h-80 md:h-[420px] rounded-lg overflow-hidden border border-[#404040]/40 shadow-2xl">
            <img
          ...
          <div className="gsap-story-img relative h-64 sm:h-80 md:h-[420px] rounded-lg overflow-hidden border border-[#404040]/40 shadow-2xl mt-6 sm:mt-8">
            <img
        ...
        <div className="lg:col-span-6 flex flex-col justify-center space-y-4 sm:space-y-6 lg:pl-6 text-center md:text-left">
          <span className="gsap-story-text text-[#C9A664] text-[10px] sm:text-xs uppercase tracking-[0.3em] font-semibold">
            Our Heritage
          </span>
          <h2 className="gsap-story-text font-serif text-2xl sm:text-3xl md:text-5xl leading-tight font-light">
            ...
            <span className="italic text-[#AE8A3E] font-normal">
              Craftsmanship
            </span>
          </h2>

          <div className="gsap-story-text space-y-3 sm:space-y-4 text-neutral-300 text-xs sm:text-sm md:text-base font-light leading-relaxed">
            <p>
              Founded in 1989,{" "}
              <strong className="text-[#EDE7DD] font-medium">
            ...
            <p>
              ...
              <span className="text-[#C9A664]">Quality Fabrics NP</span>.
            </p>
          </div>
          ...
          <div className="gsap-story-text pt-2 sm:pt-4">
            <button
              ...
              className="text-[10px] sm:text-xs uppercase tracking-[0.2em] px-6 sm:px-8 py-3.5 sm:py-4 rounded-full bg-[#AE8A3E] text-[#0a0a0a] font-semibold shadow-lg shadow-[#AE8A3E]/20 hover:bg-[#C9A664] transition-all duration-300"
            >
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-20 md:mb-28">
        {STATS.map((s, idx) => (
          <div
            key={idx}
            className="p-4 sm:p-6 md:p-8 bg-[#121212] border border-[#404040]/40 rounded-xl text-center space-y-1.5 sm:space-y-2 hover:border-[#AE8A3E]/60 transition-colors flex flex-col justify-center items-center"
          >
            <h3
              className="gsap-stat-number font-serif text-2xl sm:text-3xl md:text-5xl text-[#AE8A3E] font-normal tracking-tight whitespace-nowrap"
              data-target={s.value}
              data-suffix={s.suffix}
            >
              0
            </h3>
            <p className="text-[10px] sm:text-xs uppercase tracking-[0.15em] sm:tracking-[0.2em] text-neutral-400 font-medium leading-normal">
              {s.label}
            </p>
          </div>
        ))}
      ...
      <div className="max-w-7xl mx-auto mb-20 md:mb-28">
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 space-y-2 sm:space-y-3">
          <span className="text-[#C9A664] text-[10px] sm:text-xs uppercase tracking-[0.35em] font-semibold block">
            The Process
          </span>
          <h2 className="font-serif text-2xl sm:text-3xl md:text-5xl font-light">
            How We{" "}
            <span className="italic text-[#AE8A3E] font-normal">Tailor</span>
          </h2>
        ...
        <div className="gsap-steps-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {CRAFT_STEPS.map((step) => (
            <div
              key={step.num}
              className="gsap-step-card p-6 sm:p-8 bg-[#121212] border border-[#404040]/40 hover:border-[#AE8A3E]/80 rounded-xl transition-colors duration-300 group flex flex-col justify-between"
            >
              <div>
                <span className="font-serif text-3xl sm:text-4xl text-[#AE8A3E] block mb-4 sm:mb-6 font-light">
                  {step.num}
                </span>
                <h3 className="font-serif text-base sm:text-lg text-[#EDE7DD] mb-2 sm:mb-3 font-medium">
                  {step.title}
                </h3>
      ...
      <div className="gsap-cta max-w-7xl mx-auto bg-gradient-to-r from-black via-neutral-900 to-black border border-[#404040]/40 rounded-lg p-6 sm:p-8 md:p-12 text-center flex flex-col items-center justify-center space-y-4 sm:space-y-6">
        <span className="text-[#C9A664] text-[10px] sm:text-xs uppercase tracking-[0.3em] sm:tracking-[0.4em] font-medium">
        ...
        <h2 className="font-serif text-xl sm:text-2xl md:text-4xl max-w-2xl font-extralight leading-snug">
          ...
          <span className="italic text-[#AE8A3E]">Masterpiece</span>?
        </h2>
        <p className="text-neutral-400 text-[11px] sm:text-xs max-w-md font-light leading-relaxed">
          Visit our Putalisadak shop for a private consultation and custom
          fabric viewing.
        </p>
        <button
          onClick={() => navigate("/contact")}
          className="text-[10px] sm:text-[11px] uppercase tracking-[0.2em] sm:tracking-[0.25em] px-6 sm:px-8 py-3 sm:py-3.5 rounded-full bg-[#AE8A3E] text-[#0a0a0a] font-medium hover:bg-[#C9A664] transition-all duration-300 shadow-lg shadow-[#AE8A3E]/20"
        >
          Book Your Fitting
        </button>
      </div>
